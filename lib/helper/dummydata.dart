class DummyData {
  // this dummy data is from    'https://fakestoreapi.com/docs'
  static List<Map<String, Object>> dummyProducts = [
    {
      "id": 1,
  ...
  static List<Map<String, Object>> dummyCarts = [
    {
      "id": 1,
      "userId": 1,
  ...
  static List<Map<String, Object>> dummyUsers = [
    {
      "address": {
  ...
  static final categoriesImages = [
    'Icon_Devices.png',
    'Icon_Gadgets.png',
    'Icon_Mens Shoe.png',
    'Icon_Womens Shoe.png',
  ];
}
